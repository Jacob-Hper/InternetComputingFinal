...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("DELETE FROM Product WHERE ProductID = :product AND SupplierID = :supplier;");
    $stmt->execute(['product' => $product_id, 'supplier' => $supplier_id]);
...
<body>
    <div class="container">
        ...
        <form method="post" action="delete.php">
            ...
            <label for="quantity">Are you sure you want to delete this product?</label>
